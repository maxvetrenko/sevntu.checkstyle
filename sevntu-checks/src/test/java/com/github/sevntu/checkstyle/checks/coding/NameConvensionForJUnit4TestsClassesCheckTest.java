...
public class NameConvensionForJUnit4TestsClassesCheckTest extends BaseCheckTestSupport
{
    ...
    @Test
    public void testQualifiedNameAnnotation() throws Exception
    {
        final String[] expected = {buildMesssage("7", ".+Test|Test.+|.+IT|.+TestCase"), };
        verify(mCheckConfig,
    ...
    public void testAnnotationRunWith() throws Exception {
        final String[] expected = {buildMesssage("4", ".+Test|Test.+|.+IT|.+TestCase"), };
        verify(mCheckConfig,
                getPath("InputNameConvensionForTests9.java"),
                expected);
    }
